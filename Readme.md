# Neural Network from Scratch for MNIST and Fashion-MNIST
...
```bash
python -m src.train -d mnist -e 10 -b 64 -l cross_entropy -o rmsprop -lr 0.001 -wd 0.0001 -nhl 2 -sz 64 32 -a relu relu -w_i xavier --wandb_project da6401_assignment1 --model_save_path models/model.npy
```
